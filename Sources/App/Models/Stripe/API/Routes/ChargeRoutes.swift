...
public final class ChargeRoutes {
    ...
    public func create(amount: Int, in currency: StripeCurrency, for type: ChargeType, description: String?=nil) throws -> StripeRequest<Charge> {
        return try self.create(amount: amount, in: currency, for: type, withFee: nil, toAccount: nil, description: description, source: nil)
    }
    
    public func create(amount: Int, in currency: StripeCurrency, for type: ChargeType, description: String?=nil, source: Any?) throws -> StripeRequest<Charge> {
        return try self.create(amount: amount, in: currency, for: type, withFee: nil, toAccount: nil, description: description, source: source)
    }
    ...
    /**
     ...
     - returns: A StripeRequest<> item which you can then use to convert to the corresponding node
     */
    public func create(amount: Int, in currency: StripeCurrency, for type: ChargeType, withFee fee: Int?, toAccount account: String?, description: String?=nil, source: Any?) throws -> StripeRequest<Charge> {
        // Setup our params
        var body: [String : Any] = [
            "amount": amount,
